            ...
            <div class="app-utilities col-auto">
              <div class="app-utility-item app-notifications-dropdown dropdown">    
                ...
                <div class="app-utility-item">
				          <a href="/back/agent-info" title="Settings">
                ...
                <div class="app-utility-item app-user-dropdown dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
                    <li><a class="dropdown-item" href="/back/agent-info">Account</a></li>
                    <li><a class="dropdown-item" href="/back/agent-info">Settings</a></li>
          ...
          <div class="app-sidepanel-footer">
				    <nav class="app-nav app-nav-footer">
					    <ul class="app-menu footer-menu list-unstyled">
						    <li class="nav-item">
                  <a class="nav-link" href="/back/agent-info">
                    <span class="nav-icon">
                  ...
                  <a class="nav-link" href="/">
                    ...
                    <span class="nav-link-text">Revenir sur le site</span>
                  </a>
						    </li>
					    </ul>
				    </nav>
  ...
  <div class="app-wrapper">
    ...
    <footer class="app-footer">
      <div class="container text-center py-3">
        <small class="copyright">Copyright &copy; 2023 Moving House | All Rights Reserved.</small>
      </div>
    </footer>
    <!--END: Footer-->
